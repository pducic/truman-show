 ...
 */
public class MainActivity extends CardboardActivity implements CardboardView.StereoRenderer, ObjectRenderer {

    public static final java.lang.String AUTO_GENERATE_OBJECTS = "auto_generate_objects";
    ...
    public static final String SHOW_THE_BOX = "show_the_box";
    ...
    private boolean autoGenerateObject;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        autoGenerateObject = getIntent().getBooleanExtra(AUTO_GENERATE_OBJECTS, true);
        if(autoGenerateObject){
            showing = true;
        }
        ...
        mOverlayView.show3DToast("Click on the screen or pull the magnet when you find an object.");
    }
    ...
    protected void onResume() {
        ...
        IntentFilter intentFilter = new IntentFilter(SHOW_THE_BOX);
    ...
    private class DataUpdateReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            Log.i(TAG, "Received show_the_box broadcast event");
            if (intent.getAction().equals(SHOW_THE_BOX)) {
                if (!isShowing()) {
                    Log.i(TAG, "Setting show toggle");
                    show();
                }
            }
        }
